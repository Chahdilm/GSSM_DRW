...
df_hm_general.to_excel(PATH_OUTPUT_COMPARE_RSLT + "info_hm_per_patient_" + str(CONFIG_ALPHA)+ ".xlsx")
...
# # Group by method and compute AM and HM
# method_hm_group = df_hm_group.dropna().drop_duplicates()
# result = (
#     df_hm_group.groupby('method')['hm']
#     .agg(
...
# method_hm_group_without_rdi.to_excel(PATH_OUTPUT_COMPARE_RSLT + "hm_group_without_rdi_rarw_" + str(CONFIG_ALPHA)+ ".xlsx")

# method_hm_group.to_excel(PATH_OUTPUT_COMPARE_RSLT + "hm_group_rarw_" + str(CONFIG_ALPHA)+ ".xlsx")


# df_hm_general.to_excel(PATH_OUTPUT_COMPARE_RSLT + "hm_rdi_rarw_" + str(CONFIG_ALPHA)+ ".xlsx")
